...
Run cmake (`Meta/cryfox.py run cryfox` or similar) at least once for clangd
...
- You can build the LLVM toolchain, including `clangd`, from CryFox's repository. This is an advanced option that is not currently documented.
