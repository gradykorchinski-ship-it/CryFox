...
The Android port of CryFox has straightforward integration with the Android Studio IDE.
...
After opening the ``cryfox`` directory in Android Studio (NOT the UI/Android directory!)
