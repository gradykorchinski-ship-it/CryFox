...
There are two documented ways to support clangd in Neovim for the CryFox
project:
...
For both setups, make sure you ran `./Meta/cryfox.py run cryfox` at least
once.
...
require('lspconfig').clangd.setup {
  ...
  -- clangd version 18 for the CryFox project.
  -- cmd = { '/path/to/clangd' },
}
```
