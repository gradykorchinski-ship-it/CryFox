...
Ensure your gcc version is supported by the [build system](BuildInstructionsCryFox.md#build-prerequisites) with
...
Target "cryfox" requests linking to directory "/usr/X11R6/lib". Targets
...
(common default on virtual machines), CryFox will occasionally terminate with:

```
double free or corruption (!prev)
```

Run CryFox with `--force-cpu-painting` to make that go away.

Likely explanation ([this thread](https://github.com/CryFoxBrowser/cryfox/issues/5097)):
