...
function showSiteSettings(title, settings) {
    ...
    siteSettingsGlobal.onchange = () => {
        cryfox.sendMessage("setSiteSettingEnabledGlobally", {
    ...
    settings.siteFilters.forEach(site => {
        ...
        remove.addEventListener("click", () => {
            cryfox.sendMessage("removeSiteSettingFilter", {
                setting: currentSiteSetting(),
                filter: site,
            });
        });
...
function addSiteSettingFilter() {
    cryfox.sendMessage("addSiteSettingFilter", {
        setting: currentSiteSetting(),
...
siteSettingsRemoveAll.addEventListener("click", () => {
    cryfox.sendMessage("removeAllSiteSettingFilters", {
        setting: currentSiteSetting(),
    });
});
...
document.addEventListener("WebUILoaded", () => {
    cryfox.sendMessage("loadForciblyEnabledSiteSettings");
});
