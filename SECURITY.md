...
disclosed publicly. The preference is to report security issues as [GitHub issues](https://github.com/CryFoxBrowser/cryfox/issues/new?template=bug_report.yml).

However, private vulnerability reporting is also enabled on the repository. If you find a security issue in CryFox,
or in another web browser that you believe affects CryFox, you may report it privately to the maintainers
...
For issues that are determined to not be security issues, please report them as a [GitHub issue](https://github.com/CryFoxBrowser/cryfox/issues/new?template=bug_report.yml)
...
respective libraries. The maintainers of CryFox will work with the maintainers of these libraries to resolve the issue.
If a security issue relates more to the integration of the library into CryFox, it should be reported via the same
