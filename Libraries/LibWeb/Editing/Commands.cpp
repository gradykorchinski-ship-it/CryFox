/*
 * Copyright (c) 2024-2025, Jelle Raaijmakers <jelle@cryfox.org>
 *
...
static Array const commands {
    ...
    // AD-HOC: This is a CryFox-specific formatting command that is not part of the spec. It has no action and as
