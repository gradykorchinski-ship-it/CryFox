...
import org.serenityos.cryfox.databinding.ActivityMainBinding
...
class CryFoxActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!testFile.exists())
        {
            ZipFile("$resourceDir/cryfox-assets.zip").use { zip ->
        ...
        initNativeCode(resourceDir, "CryFox", timerService, userDir)
        ...
        view.loadURL(intent.dataString ?: "https://cryfox.dev")
    }
    ...
    companion object {
        // Used to load the 'cryfox' library on application startup.
        init {
            System.loadLibrary("CryFox")
        }
    }
}
